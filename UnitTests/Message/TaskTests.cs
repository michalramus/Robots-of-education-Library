...
namespace UnitTests.Message
{
    public class TaskTests
    {
        ...
        {
            yield return new object[] { (int)ERobotsSymbols.car, 91, (int)ERobotsSymbols.taskCarGo, new Dictionary<int, string> { { (int)ERobotsSymbols.valCarDirection, "35" }, { (int)ERobotsSymbols.valCarDistance, "25" }, }, "{\"devType\":\"car\",\"ID\":91,\"task\":\"tCarGo\",\"exValNum\":2,\"exVal\":[[\"vCarDirec\",\"35\"],[\"vCarDist\",\"25\"]]}" };
            ...
            yield return new object[] { (int)ERobotsSymbols.car, 58, (int)ERobotsSymbols.taskCarTurn, new Dictionary<int, string> { { (int)ERobotsSymbols.valCarDistance, "15" }, { (int)ERobotsSymbols.valCarSpeed, "60" }, { (int)ERobotsSymbols.valCarGoTime, "58" }, { (int)ERobotsSymbols.valCarDirection, "8" }, }, "{\"devType\":\"car\",\"ID\":58,\"task\":\"tCarTurn\",\"exValNum\":4,\"exVal\":[[\"vCarDist\",\"15\"],[\"vCarSpeed\",\"60\"],[\"vCarGoTime\",\"58\"],[\"vCarDirec\",\"8\"]]}" };
            ...
            yield return new object[] { (int)ERobotsSymbols.car, 95, (int)ERobotsSymbols.taskCarTurn, new Dictionary<int, string> { { (int)ERobotsSymbols.valCarDistance, "86" }, { (int)ERobotsSymbols.valCarDirection, "29" }, }, "{\"devType\":\"car\",\"ID\":95,\"task\":\"tCarTurn\",\"exValNum\":2,\"exVal\":[[\"vCarDist\",\"86\"],[\"vCarDirec\",\"29\"]]}" };
        ...
        {
            yield return new object[] { (int)ERobotsSymbols.car, (int)ERobotsSymbols.taskCarGo, new Dictionary<int, string> { { (int)ERobotsSymbols.valCarDirection, "35" }, { (int)ERobotsSymbols.valCarDistance, "25" }, }, };
            ...
            yield return new object[] { (int)ERobotsSymbols.car, (int)ERobotsSymbols.taskCarTurn, new Dictionary<int, string> { { (int)ERobotsSymbols.valCarDistance, "15" }, { (int)ERobotsSymbols.valCarSpeed, "60" }, { (int)ERobotsSymbols.valCarGoTime, "58" }, { (int)ERobotsSymbols.valCarDirection, "8" }, } };
            yield return new object[] { (int)ERobotsSymbols.car, (int)ERobotsSymbols.taskCarGo, new Dictionary<int, string> { }, };
            ...
            yield return new object[] { (int)ERobotsSymbols.car, (int)ERobotsSymbols.taskCarTurn, new Dictionary<int, string> { { (int)ERobotsSymbols.valCarDistance, "86" }, { (int)ERobotsSymbols.valCarDirection, "29" }, }, };
        ...
        {
            yield return new object[] { (int)ERobotsSymbols.car, 91, new Dictionary<int, string> { { (int)ERobotsSymbols.valCarDirection, "35" }, { (int)ERobotsSymbols.valCarDistance, "25" }, }, };
            ...
            yield return new object[] { (int)ERobotsSymbols.car, 58, new Dictionary<int, string> { { (int)ERobotsSymbols.valCarDistance, "15" }, { (int)ERobotsSymbols.valCarSpeed, "60" }, { (int)ERobotsSymbols.valCarGoTime, "58" }, { (int)ERobotsSymbols.valCarDirection, "8" }, } };
            ...
            yield return new object[] { (int)ERobotsSymbols.car, 95, new Dictionary<int, string> { { (int)ERobotsSymbols.valCarDistance, "86" }, { (int)ERobotsSymbols.valCarDirection, "29" }, }, };
